...
This is a LiveKit Agents project - a Python voice AI assistant using LiveKit Cloud. The agent uses a voice pipeline with OpenAI (LLM), Cartesia (TTS), and AssemblyAI (STT).
